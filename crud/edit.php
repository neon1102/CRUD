...
if(isset($id, $product_name, $code, $date, $description, $price, $quantity) && 
    ($product_name&&$code&&$date&&$description&&$price&&$quantity&&$id) != ""){
